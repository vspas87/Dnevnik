...
handleCreate = async (e) => {
     var url = 'http://localhost:8095/dnevnik/user/addteacher?username=' + this.state.username + 
     ...
     if(response.ok) {
         ...
         alert('Just created new teacher and user. Please refresh!');
     } else {            
...
console.log(this.props);
 return (
     ...
     <input 
       ...
       <br />
     <button
       value="Save new teacher/user"
       onClick={() => this.handleCreate()}
     >Save new teacher and user directly!
     </button>  
     <br />  
     </div>
     )
